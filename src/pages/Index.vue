    ...
    <div class="q-pa-md">
      <template v-if="loading">
        <div class="col q-ma-md">
          ...
          <div class="text-center">
            <div class="text-h4 text-blue-grey-9">Hi, I am Jack</div>
            <div class="text-subtitle2 text-blue-grey-9">A junior web developer</div>
          </div>
          ...
          <section id="welcome-section" class="welcome-section">
            ...
            <div class="text-body1" style="width:70%">
              I am a Vietnamese coder based in Sydney. I mainly work on
            ...
            <q-img
              ...
              src="https://i.imgur.com/RithXQF.jpg"
          ...
          <section id="contact" class="contact-section">
            <div class="text-h6 text-italic text-blue-grey-9">You can find me on</div>
            <div class="row">
              <div class="col q-ma-md text-red-4">
                <a href="https://github.com/jackdo69">
                  <i class="fab fa-github fa-4x"></i>
                </a>
              </div>
              <div class="col q-ma-md text-red-4">
                <a href="https://www.instagram.com/jack_do68/?hl=en">
                  <i class="fab fa-instagram fa-4x"></i>
                </a>
              </div>
              <div class="col q-ma-md text-red-4">
                <a href="https://www.messenger.com/t/portgas.ace.93/">
      ...
      <template v-else>
        <span class="absolute-center">
          <q-spinner-tail color="teal" size="8em" :thickness="5" />
        </span>
      </template>
